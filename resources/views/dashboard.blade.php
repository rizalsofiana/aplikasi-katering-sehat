                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 flex flex-col justify-between">
                        <div class="flex justify-between items-center">
                            ...
                            <span
                                class="text-xs font-bold text-purple-600 bg-purple-50 px-2 py-0.5 rounded">Paket</span>
                        </div>
                        <div class="mt-4">
                            <h4 class="text-2xl font-bold text-gray-400">Tidak Aktif</h4>
                            <a href="#"
                                class="text-xs text-green-600 hover:underline font-semibold block mt-1">Pilih paket
                                sehatmu →</a>
                        </div>
                    </div>
