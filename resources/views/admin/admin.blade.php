<x-app-layout>
    <div class="py-8 px-6 space-y-6">
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            <h3 class="text-xl font-bold text-slate-900">Selamat Datang di Panel Kendali Admin</h3>
            <p class="text-sm text-slate-500 mt-0.5">Manajemen Operasional Sistem Katering Sehat AI.</p>
        </div>
