...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-emerald-800 text-sm font-medium leading-5 text-white focus:outline-none focus:border-emerald-800 transition duration-150 ease-in-out'
