...
<body class="antialiased bg-slate-50 text-slate-800">
    ...
    <nav x-data="{ open: false }" class="bg-white border-b border-slate-100 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-2">
                    <img class="w-16 h-12 object-contain" src="{{ asset('logo-katering-sehat.png') }}"
                        alt="Logo Katering Sehat">
                ...
                <div class="flex sm:hidden items-center">
                    <button @click="open = !open" type="button"
                        class="text-slate-500 hover:text-slate-900 focus:outline-none p-2 rounded-lg hover:bg-slate-50"
        ...
        <div x-show="open" x-transition
            class="sm:hidden border-t border-slate-100 bg-white px-4 pt-2 pb-4 space-y-2 shadow-inner">
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="block w-full py-2.5 text-base font-semibold text-slate-700 hover:text-emerald-600 transition">Dashboard</a>
                @else
                    <a href="{{ route('login') }}"
                        class="block w-full text-center bg-white text-emerald-600 px-4 py-2.5 rounded-xl border-2 border-emerald-400 text-base font-semibold hover:bg-emerald-400 hover:text-white transition shadow-sm">Masuk</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="block w-full text-center bg-emerald-600 text-white px-4 py-2.5 rounded-xl text-base font-semibold hover:bg-emerald-700 transition shadow-sm">
                            Daftar Sekarang
                        </a>
                    @endif
                @endauth
    ...
    <header class="relative overflow-hidden bg-white py-16 lg:py-32 border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6 text-center lg:text-left">
                ...
                <h1 class="text-3xl sm:text-5xl font-black text-slate-950 leading-tight">
                    Makan Sehat Ala Resto, <br class="hidden sm:block">
                    <span class="text-emerald-600">Sesuai Kebutuhan Kalorimu.</span>
                </h1>
                <p class="text-sm sm:text-base text-slate-600 max-w-xl mx-auto lg:mx-0">
                ...
                <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-2">
                    <a href="{{ route('register') }}"
                        class="bg-emerald-600 text-white text-center px-6 py-3 rounded-xl font-bold hover:bg-emerald-700 transition shadow-md shadow-emerald-200 text-sm sm:text-base">
    ...
    <section id="fitur" class="py-16 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center max-w-2xl mx-auto mb-12">
                <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-950">Mengapa Memilih KateringSehat.AI?</h2>
                <p class="text-xs sm:text-sm text-slate-600 mt-2">Solusi praktis makan sehat untuk mengatasi kejenuhan
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100 space-y-4">
                    ...
                    <h3 class="text-base sm:text-lg font-bold text-slate-900">Personalisasi Menu AI</h3>
                ...
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100 space-y-4">
                    ...
                    <h3 class="text-base sm:text-lg font-bold text-slate-900">Pengantaran Terjadwal</h3>
                    <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100 space-y-4">
                    ...
                    <h3 class="text-base sm:text-lg font-bold text-slate-900">Konsultasi Gizi Gratis</h3>
                    <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
    ...
    <footer class="bg-white border-t border-slate-100 py-8 text-center text-[11px] sm:text-xs text-slate-500">
